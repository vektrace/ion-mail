...
enum AccountOperation {
    ...
    ///
    /// This will delete the account configuration from your local machine.
    /// This action is IRREVERSIBLE and does delete the actual
    /// mail on the server.
    Delete {
        /// The ID or email of the account to delete
        account: String,
    },
    /// Log out of an account and clear active sessions.
    ///
    /// This command invalidates the local authentication token or session
    /// for the specified account. Unlike 'delete', this keeps your
    /// account settings (like server addresses) intact.
    Logout {
